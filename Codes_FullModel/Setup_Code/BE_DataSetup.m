...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path_name = '../Figures/Miscellaneous_Plots';  %This is the folder where the miscellaneous plots are saved - vaccine arrival probability, daily tests fit
...
saveas(Figure_p, fullfile(path_name, 'pdf_VaccineArrival'), 'jpeg');
saveas(Figure_p, fullfile(path_name, 'pdf_VaccineArrival'), 'pdf');
...
saveas(Figure_cdf_p, fullfile(path_name, 'cdf_VaccineArrival'), 'jpeg');
saveas(Figure_cdf_p, fullfile(path_name, 'cdf_VaccineArrival'), 'pdf');
...
saveas(Figure_q, fullfile(path_name, 'q_NoVaccineArrival'), 'jpeg');
saveas(Figure_q, fullfile(path_name, 'q_NoVaccineArrival'), 'pdf');
...
hold off
saveas(Figure_Test, fullfile(path_name, 'DailyTests'), 'jpeg');
saveas(Figure_Test, fullfile(path_name, 'Daily_Tests'), 'pdf');
...
Fixed_ParamValues = [11, 9, (100/(pop*1e6)), da/0.99, 1e-12, 0.3, 0.0034, 5, 0.5];
